...
class model_zambezi:
    ...
    def simulate(self):
        ...
        rDelta = open("../storage_release/new_feature/rDelta_"+self.PolicySim+".txt", 'w+')
        irrigation = open("../storage_release/new_feature/irr_"+self.PolicySim+".txt", 'w+')

        mass_balance_ReservoirSim = dict()
        qturb_ReservoirSim = dict()

        for reservoir in ['cb', 'itt', 'ka', 'kgu', 'kgl']:
            qturb_ReservoirSim[reservoir] = open("../storage_release/new_feature/qturb_"+reservoir+"_"+self.PolicySim+".txt", 'w+')
            mass_balance_ReservoirSim[reservoir] = open("../storage_release/new_feature/"+reservoir+"_"+self.PolicySim+".txt", 'w+')
